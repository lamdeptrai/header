...
if (!class_exists('TNCP_Header')){
    class TNCP_Header extends TNCP_ToanNang{

        protected $options = [
            'menu' => 'main-menu',
            'tieu_de_banner' => 'THIẾT KẾ WEBSITE CHUYÊN NGHIỆP',
            'danh_sach_cac_dich_vu' => [
                    ['ten_dich_vu' => 'Google','duong_dan' => 'http://google.com'],
                    ['ten_dich_vu' => 'Google','duong_dan' => 'http://google.com'],
                    ['ten_dich_vu' => 'Google','duong_dan' => 'http://google.com'],
            ],
            'cam_ket' => 'Tiêu chuẩn quốc tế - quản trị thông minh - bảo mật cao - responsive - tối ưu SEO & marketing',
            'form' => '[gravityform id="1" title="false" description="false"]'
        ];
                ...
                <div class="header_toannang_group">
                            ...
                            <div class="row">
                                <div class="col-md-3 col-xs-10 header_toannang_flex_mb">
                                    ...
                                    <div id="page" class="v-menu-mobile">
                                        ...
                                        <nav id="menu">
                                            <?php if(wp_is_mobile()){
                                                wp_nav_menu(array('menu' => $this->getOption('menu')));
                                            }?>
                                        </nav>
                                    </div>
                                ...
                                <div class="col-md-9 col-xs-12">
                                    <!--MENU DESKTOP-->
                                    <?php if(!wp_is_mobile()) :?>
                                        <?php $menus = wp_get_nav_menu_items($this->getOption('menu'));?>
                                        <?php if(!empty($menus)): ?>
                    ...
                    <div class="header_toannang-slogon">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6">
                                    <h2><?php echo $this->getOption('tieu_de_banner')?></h2>
                                    <?php $dichvu = $this->getOption('danh_sach_cac_dich_vu')?>
                                    <ul>
                                    ...
                                    <div class="header_toannang-slogon-cmt">
                                        <?php echo $this->getOption('cam_ket') ?>
                                    </div>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php echo do_shortcode($this->getOption('cam_ket'))?>
                        </div>
